          ...
          <ul class="sidebar-menu">
            ...
            <!-- <li>
              ...
              <ul class="treeview-menu">
                ...
                <li class="active treeview"><a href="index-user.php"><i class="fa fa-circle-o"></i>Dashboard</a></li>
                <li><a href="kepanitian-user.php"><i class="fa fa-circle-o"></i>Kepanitian</a></li>
                <li><a href="#"><i class="fa fa-circle-o"></i>Lokasi</a></li>
                <li><a href="#"><i class="fa fa-circle-o"></i>Tata Tertib & Susunan Acara</a></li>
                <li><a href="#"><i class="fa fa-circle-o"></i>Dresscode Tambahan</a></li>
              </ul>
            </li> -->
            ...
            <li>
              <a href="rundown-day-tatib.php">
                ...
                <i class="fa fa-list"></i> <span>Run Down & Tata Tertib</span> 
              </a>
            </li>
            <!-- l -->
