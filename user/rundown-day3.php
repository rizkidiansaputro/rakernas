...
<h2> Day 3 <small> Rabu, 08 Februari 2023</small></h2>
        ...
        <ul class="timeline">
                            ...
                            <li class="event" data-date="08:00 WIB - 09:30 WIB">
                                ...
                                <p>Dodik Sugeng H</p>
                                <p><a href="../admin/materi_event/PROGRAM KERJA DIVISI BISNIS RENTAL & USLA RKAP 2023 NEW.pdf" onclick="return confirm('Apakah ingin download materi ini ?')"><i class="fa fa-file"></i>&nbsp;&nbsp;Download Materi</a></p>
                            ...
                            <li class="event" data-date="10:00 WIB - 11:30 WIB">
                                ...
                                <!-- <p><a href="#" onclick="alert('File belum di upload')"><i class="fa fa-file"></i>&nbsp;&nbsp;Download Materi</a></p> -->
                                <p><a href="../admin/materi_event/007 Presentasi Divisi SDM & Logistik Tahun 2023 (4).pptx" onclick="return confirm('Apakah ingin download materi ini ?')"><i class="fa fa-file"></i>&nbsp;&nbsp;Download Materi</a></p>
                                <p>Lokasi: R. Borobudur 1 Hotel Santika Premiere Semarang</p>
                            </li>
                            ...
                            <li class="event" data-date="13:30 WIB - 15:00 WIB">
                                ...
                                <p><a href="../admin/materi_event/Materi Keuangan.pdf" onclick="return confirm('Apakah ingin download materi ini ?')"><i class="fa fa-file"></i>&nbsp;&nbsp;Download Materi</a></p>
                                <p>Lokasi: R. Borobudur 1 Hotel Santika Premiere Semarang</p>
                            </li>
                            ...
                            <li class="event" data-date="18:00 WIB - 21:00 WIB">
                                ...
                                <p>Panitia</p>
                                <p><img src="../global-data/rundown-image/Restoran Kampung Laut Semarang.jpg" class="user-image" style="border: 1px solid white; width:150px; height:150px;" alt="Restoran Kampung Laut Semarang"></p>
                                <p>Restoran Kampung Laut Semarang</p>
                                <p><iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15841.600246095233!2d110.3860703!3d-6.962044!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x34e7dea74586cb2c!2sRestoran%20Kampung%20Laut%20Semarang!5e0!3m2!1sid!2sid!4v1675409313402!5m2!1sid!2sid" width="200" height="200" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></p>
