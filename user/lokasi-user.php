...
<div>
  <h1>Daftar Lokasi - Lokasi Rakernas 2023</h1>
  <table class="center table-responsive table-hover table-bordered" style="width:80%; height:100%">
      <thead>
        <tr>
          ...
          <th width="30%" style="text-align:center;">Acara/Kegiatan</th>
          <th width="15%" style="text-align:center;">URL Map</th>
      ...
      <tbody>
        <tr>
          ...
          <td>Hotel Santika Premiere, Semarang, Jawa Tengah</td>
          <td>Check In & Registrasi serta Souvenir || <small>(Hari ke-1)</td>
        ...
        <tr>
          ...
          <td>Restoran Kampung Laut Semarang</td>
          <td>Dinner || <small>(Hari ke-3)</small></td>
        ...
        <tr>
          ...
          <td>Bukit Cinta Rawa Pening</td>
          <td>One Day Outbond  || <small>(Hari ke-4)</small></td>
        ...
        <tr>
          ...
          <!-- <td>Restoran Layang-layang</td>
          <td>Dinner || <small>(Hari ke-4)</small></td>
          <td style="text-align:center;"><a href="https://goo.gl/maps/6HyfbBBsqFiNbJTG9"><i class="fa fa-map"> Click go to Maps</i></a></td> -->
          <td>Restoran TRUNTUM GAMA</td>
          <td>Dinner || <small>(Hari ke-4)</small></td>
          <td style="text-align:center;"><a href="https://goo.gl/maps/KKnmxNEQS7XQaXen9"><i class="fa fa-map"> Click go to Maps</i></a></td>
          <!-- <td>Memimpin dan mengkoordinasikan seluruh acara Rakernas</td> -->
          <!-- <td style="text-align:center;"><a href="https://api.whatsapp.com/send?phone=6281293867494&text=Rakernas-2023%"><i class="fa fa-whatsapp"></i> Hubungi via whatsapp</a></td> -->
        </tr>
      </tbody>
