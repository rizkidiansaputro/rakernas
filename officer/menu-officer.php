        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <!-- <li><a href="../countdown.php"><i class="fa fa-circle-o"></i> Scan QR Kehadiran </a></li>
                <li><a href="../countdown.php"><i class="fa fa-circle-o"></i> Scan QR Merchandise</a></li> -->
                <!-- <li><a href="absensi.php"><i class="fa fa-circle-o"></i> Scan QR Kehadiran </a></li> -->
                <li><a href="../countdown-officer-absensi.php"><i class="fa fa-circle-o"></i> Scan QR Kehadiran </a></li>
                <!-- <li><a href="merchandise.php"><i class="fa fa-circle-o"></i> Scan QR Merchandise</a></li> -->
                <li><a href="../countdown-officer-merchandise.php"><i class="fa fa-circle-o"></i> Scan QR Merchandise</a></li>
                <!-- <li><a href="uangSaku.php"><i class="fa fa-circle-o"></i> Scan QR Uang Saku</a></li> -->
                <li><a href="../countdown-officer-uangSaku.php"><i class="fa fa-circle-o"></i> Scan QR Uang Saku</a></li>
              </ul>
            </li>
            <li>
              <a href="#">
