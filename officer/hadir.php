        ...
        <section class="content">
          ...
          <div class="row">
           ...
           <input type='submit' value='Cari Data' class="btn btn-sm btn-primary" /> <a href='admin.php' class="btn btn-sm btn-success" >Refresh</i></a>
            ...
            <a href="../countdown-officer-merchandise.php" class="btn btn-sm btn-info"><i class="fa fa-plus"></i> Scan QR Code Merchandise</a> &nbsp; &nbsp;
            <!-- <a href="uangSaku.php" class="btn btn-sm btn-info"><i class="fa fa-plus"></i> Scan QR Code Uang Saku</a> &nbsp; &nbsp; -->
            <a href="../countdown-officer-uangSaku.php" class="btn btn-sm btn-info"><i class="fa fa-plus"></i> Scan QR Code Uang Saku</a> &nbsp; &nbsp;
            <br /><br />
